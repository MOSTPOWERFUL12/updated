...
var mat = new THREE.ShaderMaterial({
  uniforms: {
    uTime: {value: 0},
    uLight: {value: new THREE.Color(0x87CEEB).multiplyScalar(1.5)}, // Sky blue color
    uColor: {value: new THREE.Color(0x87CEEB).multiplyScalar(1)},   // Sky blue color
    uFire: {value: new THREE.Color(1, 0.75, 0)} // Keep the fire color as is
  },
  vertexShader:`
    uniform float uTime;
...
loader.load("https://cywarr.github.io/small-shop/fish.stl", objGeom => {
  ...
  let objMat = new THREE.MeshBasicMaterial({color: 0x0000ff, wireframe: true}); // Change the color to blue
